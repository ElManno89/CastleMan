...
import com.example.application.views.dashboard2.Dashboard2View;
import com.example.application.views.gridwithfilters.GridwithFiltersView;
import com.example.application.views.helloworld.HelloWorldView;
import com.example.application.views.termine.TermineView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("Castlemanager v0.1");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Dashboard2", LineAwesomeIcon.DOLLAR_SIGN_SOLID.create(), Dashboard2View.class), //

                new MenuItemInfo("Termine", LineAwesomeIcon.LIST_SOLID.create(), TermineView.class), //
